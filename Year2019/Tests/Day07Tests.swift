...
final class Day07Tests: XCTestCase {
    ...
    func testPart1Example1() throws {
        ...
        let output = try Day07().calculatePart1(code: code, phases: [4,3,2,1,0])
    ...
    func testPart1Example2() throws {
        ...
        let output = try Day07().calculatePart1(code: code, phases: [0,1,2,3,4])
    ...
    func testPart1Example3() throws {
        ...
        let output = try Day07().calculatePart1(code: code, phases: [1,0,4,3,2])
    ...
    func testPart2Example1() throws {
        let code = [3,26,1001,26,-4,26,3,27,1002,27,2,27,1,27,26,
                    27,4,27,1001,28,-1,28,1005,28,6,99,0,0,5]
        let output = try Day07().calculatePart2(code: code, phases: [9,8,7,6,5])
        XCTAssertEqual(output, 139629729)
    }

    func testPart2Example2() throws {
        let code = [3,52,1001,52,-5,52,3,53,1,52,56,54,1007,54,5,55,1005,55,26,
                    1001,54,-5,54,1105,1,12,1,53,54,53,1008,54,0,55,1001,55,1,
                    55,2,53,55,53,4,53,1001,56,-1,56,1005,56,6,99,0,0,0,0,10]
        let output = try Day07().calculatePart2(code: code, phases: [9,7,8,5,6])
